...
- feedback singkat, ramah, dan memberi petunjuk perbaikan bila gagal.`
  ...
  try {
    ...
    console.warn('Validasi role AI gagal:', err?.message || String(err))
    return json({
      valid: false,
      score: 0,
      retryable: true,
      feedback: 'Validasi AI sedang gagal membaca format jawaban. Tekan kirim lagi beberapa detik lagi; jawabanmu tidak hilang.'
    }, 200, origin)
  }
}
...
- feedback maksimal 2 kalimat.`
  ...
  try {
    ...
    console.warn('Validasi bantuan teman AI gagal:', err?.message || String(err))
    return json({
      valid: false,
      score: 0,
      retryable: true,
      feedback: 'Validasi AI sedang gagal membaca format bantuan. Coba kirim ulang beberapa detik lagi.'
    }, 200, origin)
  }
}
