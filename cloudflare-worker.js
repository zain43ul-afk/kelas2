 ...
 * - TEXT_MODEL        default: @cf/meta/llama-3.1-8b-instruct
...
async function workersAiText(env, prompt, options = {}) {
  ...
  const model = String(env.TEXT_MODEL || '@cf/meta/llama-3.1-8b-instruct').trim()
...
Rubrik 0-100:
- relevansi langsung dengan kasus 40 poin
- benar-benar menjalankan tugas role 30 poin
- spesifik dan punya makna, bukan kalimat kosong 20 poin
- jelas dan membantu tim 10 poin
...
- untuk draft/jawaban akhir, harus terkait keputusan dan memberi alasan yang dapat dipertanggungjawabkan.
- jika terdapat Kartu Kejutan/kondisi tambahan dan task adalah writer-draft atau writer-submit, jawaban WAJIB menyesuaikan kondisi tambahan tersebut secara nyata. Jika kondisi tambahan diabaikan, batasi score maksimal 60 dan nyatakan valid=false.
