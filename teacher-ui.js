(function(){
  ...
  window.DMTeacherUI={refresh,switchView,switchActivePanel,toggleAnswers,toggleCaseViewer,toggleAnalysis,focusLeaderboard,updateDateChip,setDifficulty,generateCases,resetAiForm,setMode};
