(function(){
  ...
  window.DMTeacherUI={refresh,switchView,switchActivePanel,toggleAnswers,toggleCaseViewer,toggleAnalysis,toggleQuickMenu,focusLeaderboard,updateDateChip,setDifficulty,generateCases,resetAiForm,setMode};
